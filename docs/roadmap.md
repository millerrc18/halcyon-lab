...
- 24 research documents (regime timeline, company profiles, compute schedule, API comparison, options, fund path, market assessment, v2 training spec, master business plan)
