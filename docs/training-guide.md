...
1. **Historical Backfill** — Real historical setups with known outcomes, scored by the feature engine, commentary generated by Claude
2. **Live Outcomes** — Shadow trade results converted to training examples
3. **Synthetic** — Claude-generated examples for bootstrapping
4. **Contrastive Pairs** — Similar inputs with opposite outcomes, teaching the model to identify subtle distinguishing factors
